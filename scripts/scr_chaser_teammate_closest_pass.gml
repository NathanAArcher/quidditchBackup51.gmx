...
if(instance_exists(obj_passmarker)){
    with obj_player_teammate{
        if st_position < 3 and ch_off_broom == false and tackle == false{
            if instance_nearest(obj_passmarker.x, obj_passmarker.y, obj_player_teammate).x == x and instance_nearest(obj_passmarker.x, obj_passmarker.y, obj_player_teammate).y == y{
                if argument0 == "x"{
                    return x;
                }
                if argument0 == "y"{
